          ...
          <div class="row mb-3">
            <div class="col-md-6 col-sm-6">
              <div class="form-check">
                ...
                <div v-if="errors.australianResident" class="text-danger">{{ errors.australianResident }}</div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6">
...
const submitForm = () => {
  ...
  if (
    ...
    !errors.value.australianResident &&
    !errors.value.gender &&
    !errors.value.reason
  ) {
...
const validateAustralianResident = () => {
  if (!formData.value.isAustralian) {
    errors.value.australianResident = 'Confirmation as an Australian resident is required.'
  } else {
    errors.value.australianResident = null
  }
}
